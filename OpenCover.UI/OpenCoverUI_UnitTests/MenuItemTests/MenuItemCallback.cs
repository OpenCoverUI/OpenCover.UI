...
namespace OpenCoverUI_UnitTests.MenuItemTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		{
			// Create the package
			IVsPackage package = new OpenCoverUIPackage() as IVsPackage;
			...
			CommandID menuCommandID = new CommandID(OpenCover.UI.GuidList.GuidOpenCoverUICmdSet, (int)OpenCover.UI.PkgCmdIDList.CmdidCoverWithOpenCover);
