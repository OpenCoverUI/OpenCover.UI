...
namespace OpenCoverUI_UnitTests.MyToolWindowTest
{
	[TestClass()]
	public class ShowToolWindowTest
	{
		...
		public void ValidateToolWindowShown()
		{
			...
			MethodInfo method = typeof(OpenCoverUIPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
