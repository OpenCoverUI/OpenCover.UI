...
namespace OpenCoverUI_IntegrationTests
{
	...
	public class MenuItemTest
	{
		...
		public void LaunchCommand()
		{
			...
			{
				CommandID menuItemCmd = new CommandID(OpenCover.UI.GuidList.GuidOpenCoverUICmdSet, (int)OpenCover.UI.PkgCmdIDList.CmdidCoverWithOpenCover);

				// Create the DialogBoxListener Thread.
				string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "OpenCoverUI", "OpenCover.UI.OpenCoverUIPackage");
